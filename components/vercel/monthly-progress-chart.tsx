...
export function MonthlyProgressChart() {
  return (
    <Card className="border bg-card shadow-none">
      <CardHeader>
        <CardTitle className="text-xl font-semibold">Statistical Improvement</CardTitle>
        <p className="text-sm text-muted-foreground">Monthly progress tracking over 4 weeks</p>
      </CardHeader>
      <CardContent>
        <ChartContainer
          config={{
